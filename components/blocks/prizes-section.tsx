  ...
  return (
    <section className={cn("w-full  text-white", "py-12 md:py-16 h-full w-full flex items-center justify-center", className)} aria-labelledby="prizes-heading">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <div className="md:col-span-3">
            <div className=" border border-red-600 overflow-hidden h-full mr-2 cursor-target">
              ...
              <div className="relative bg-red-700/90 p-6 md:p-10">
                ...
                <span
                  aria-hidden="true"
                  className="pointer-events-none absolute -right-2 -top-4 text-8xl md:text-9xl font-black text-red-900/30 select-none"
                >
                  01
                </span>
            ...
            <div className="h-full  border border-red-600 overflow-hidden mr-2">
              ...
              <div className="relative p-5 md:p-6 flex items-center gap-4 md:gap-5 bg-red-700/90 cursor-target">
                ...
                <div className="flex-1">
                  <p className="text-2xl md:text-3xl font-extrabold leading-none text-white">Rs 10,000</p>
                  <p className="mt-1 text-base md:text-lg font-semibold">1st Runner Up • worth of prizes</p>
                </div>
              </div>
              ...
              <div className="relative p-5 md:p-6 flex items-center gap-4 md:gap-5 bg-black cursor-target">
                ...
                <div className="flex-1">
                  <p className="text-2xl md:text-3xl font-extrabold leading-none text-white">Rs 10,000</p>
                  <p className="mt-1 text-base md:text-lg font-semibold">2nd Runner Up • worth of prizes</p>
                </div>
              </div>
        ...
        <div className="mt-8 rounded-md border border-red-600 bg-black p-4 text-center hidden">
